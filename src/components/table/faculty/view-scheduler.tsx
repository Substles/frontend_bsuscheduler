...
import InputCol from "./view/input-col";
import InputSection from "./view/input-section";
import InputScheduleState from "./view/input-schedule-state";

import { getScheduleBySemAndYear, getScheduleState } from "@/services/api/faculty";
...
function FacultySchedule({ facultyId }: FacultyScheduleProps) {
  ...
  // fetch data based on facultyId, semester, and year
  useEffect(() => {
    const fetchData = async () => {
      const semester = searchParams.get("sem");
      const year = searchParams.get("year");

        console.log(facultyId, semester, year)
  ...
  }, [facultyId, searchParams, resetSchedules, dispatch, setStateSchedule]);
